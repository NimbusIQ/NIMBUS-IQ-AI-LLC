...
// --- Configuration ---
const SYSTEM_INSTRUCTION = `You are Nimbus, the advanced AI assistant for Nimbus IQ AI, LLC. 
Your tone is professional, innovative, and helpful. 
You specialize in explaining Nimbus IQ's services: Cloud Architecture, Predictive Analytics, and Generative AI Integration.
    ...
    <div className="relative pt-32 pb-20 sm:pt-40 sm:pb-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className="flex justify-center gap-4">
          <a href="#demo" className="flex items-center gap-2 bg-gradient-to-r from-nimbus-500 to-blue-600 hover:from-nimbus-400 hover:to-blue-500 text-white px-8 py-4 rounded-full font-bold text-lg transition-all shadow-lg shadow-nimbus-500/20">
            <Bot className="h-5 w-5" />
            Talk to Nimbus
          </a>
          <a href="#services" className="flex items-center gap-2 bg-slate-800 hover:bg-slate-700 text-white px-8 py-4 rounded-full font-bold text-lg transition-all border border-slate-700">
            Explore Solutions
          </a>
        </div>
      </div>
...
const ServiceCard = ({ icon, title, description }: ServiceCardProps) => (
  <div className="p-8 rounded-2xl bg-slate-800/50 border border-slate-700 hover:border-nimbus-500/50 transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-nimbus-500/10 group">
...
const Services = () => {
  return (
    <div id="services" className="py-24 bg-slate-950 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
const ChatDemo = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: 'model', text: "Hello. I am Nimbus. How can I assist you with your AI strategy today?" }
  ]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row gap-12 items-center">
        ...
        <div className="md:w-1/2">
          ...
          <p className="text-slate-400 text-lg mb-8">
            Interact with our proprietary interface powered by the latest Gemini models. 
            Ask about our services, cloud security, or simply test its reasoning capabilities.
          </p>
          ...
          <ul className="space-y-4 text-slate-300">
            ...
            <li className="flex items-center gap-3">
              ...
              <span>Real-time cloud context integration</span>
            </li>
            <li className="flex items-center gap-3">
        ...
        <div className="md:w-1/2 w-full">
          <div className="bg-slate-950 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden flex flex-col h-[500px]">
            {/* Chat Header */}
            <div className="bg-slate-900 p-4 border-b border-slate-800 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-nimbus-500 to-blue-600 flex items-center justify-center">
                  <Bot className="h-4 w-4 text-white" />
                </div>
                <div>
                  <div className="font-bold text-sm text-white">Nimbus Assistant</div>
                  <div className="text-xs text-nimbus-400">Online</div>
                </div>
              </div>
            </div>
              ...
              {messages.map((msg, idx) => (
                <div key={idx} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                  <div className={`max-w-[80%] rounded-2xl px-4 py-3 text-sm leading-relaxed ${
                    msg.role === 'user' 
                      ? 'bg-nimbus-600 bg-gradient-to-r from-blue-600 to-nimbus-500 text-white rounded-br-none' 
            ...
            <div className="p-4 bg-slate-900 border-t border-slate-800">
              <div className="relative">
                <input
                  ...
                  placeholder="Ask Nimbus about AI solutions..."
                  className="w-full bg-slate-950 border border-slate-700 text-white rounded-xl pl-4 pr-12 py-3 focus:outline-none focus:border-nimbus-500 transition-colors placeholder:text-slate-600"
                />
                <button 
                  onClick={handleSend}
                  disabled={loading}
                  className="absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-nimbus-500 hover:bg-nimbus-400 text-slate-900 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
...
const Footer = () => (
  <footer className="bg-slate-950 py-12 border-t border-slate-800 text-slate-400 text-sm">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div>
        ...
        <ul className="space-y-2">
          <li><a href="#" className="hover:text-nimbus-400">Generative AI</a></li>
          <li><a href="#" className="hover:text-nimbus-400">Cloud Migration</a></li>
          <li><a href="#" className="hover:text-nimbus-400">Data Analytics</a></li>
          <li><a href="#" className="hover:text-nimbus-400">Security & Compliance</a></li>
        </ul>
      </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-8 border-t border-slate-900 text-center">
...
const NimbusApp = () => {
  return (
    <div className="min-h-screen bg-nimbus-900 text-slate-200">
      <Navbar />
      <main>
        <Hero />
        <Services />
